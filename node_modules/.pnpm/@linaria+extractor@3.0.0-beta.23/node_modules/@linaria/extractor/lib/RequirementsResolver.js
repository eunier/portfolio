...
class RequirementsResolver {
    ...
    switch (binding.kind) {
      case 'module':
        if (binding.path.isImportSpecifier() && binding.path.parentPath.isImportDeclaration()) {
          ...
          result = (_binding$path$parentP = binding.path.parentPath) === null || _binding$path$parentP === void 0 ? void 0 : _binding$path$parentP.node;
        }
  ...
  resolveIdentifier(path) {
    ...
    if (path.isReferenced() && binding && !this.isAdded(binding.path) && binding.kind !== 'param') {
