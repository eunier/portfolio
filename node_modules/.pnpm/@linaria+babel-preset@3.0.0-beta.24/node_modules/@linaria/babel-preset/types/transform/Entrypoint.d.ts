...
export declare class Entrypoint extends BaseEntrypoint {
    ...
    readonly pluginOptions: StrictOptions;
    ...
    static createRoot(services: Services, name: string, only: string[], loadedCode: string | undefined, pluginOptions: StrictOptions): Entrypoint;
    /**
     ...
     */
    protected static create(services: Services, parent: ParentEntrypoint, name: string, only: string[], loadedCode: string | undefined, pluginOptions: StrictOptions): Entrypoint | 'loop';
    private static innerCreate;
    abortIfSuperseded(): void;
