import type { IProcessEntrypointAction, SyncScenarioForAction, YieldArg } from '../types';
/**
...
export declare namespace processEntrypoint {
    var recover: (e: unknown, action: IProcessEntrypointAction) => YieldArg;
}
