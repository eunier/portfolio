...
const cookModuleId = rawId => {
  return rawId // It's a dirty hack for avoiding conflicts with babel-preset-react-app
  ...
  .replace('/@babel/runtime/helpers/esm/', '/@babel/runtime/helpers/') // The same hack for SWC helpers
