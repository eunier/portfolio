...
- [contact-send-msg](tasks/contact-send-msg.md)
- [mode-statis-data-to-separate-file](tasks/mode-statis-data-to-separate-file.md)
- [footer-social-links](tasks/footer-social-links.md)
- [footer](tasks/footer.md)
- [remove-bs-utils](tasks/remove-bs-utils.md)
- [remove-css-utils](tasks/remove-css-utils.md)
- [remove-jss](tasks/remove-jss.md)
- [npm-link](tasks/npm-link.md)
- [copyright](tasks/copyright.md)
- [contact](tasks/contact.md)
- [about](tasks/about.md)
